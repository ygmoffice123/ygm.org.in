...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        process.env.VITE_EMAIL_JS_SERVICE_ID, // EmailJS service ID
        process.env.VITE_EMAIL_JS_TEMPLATE_ID, // Admin template ID
        ContactLeftRef.current,
        process.env.VITE_EMAIL_JS_PUBLIC_KEY // Public key
      )
      .then(() => {
